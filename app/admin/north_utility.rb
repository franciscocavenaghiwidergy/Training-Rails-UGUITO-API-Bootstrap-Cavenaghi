NORTH_UTILITY_PERMITTED_KEYS = %i[
...
ActiveAdmin.register NorthUtility do
  ...
  permit_params *NORTH_UTILITY_PERMITTED_KEYS
  ...
  controller do
    define_method :permitted_params do
      params.permit(active_admin_namespace.permitted_params, north_utility: NORTH_UTILITY_PERMITTED_KEYS)
    end
  end
